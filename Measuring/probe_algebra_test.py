...
if __name__ == '__main__':
    ...
    var_test()
    """
    text = "By rolling over in her upper berth, Tatyana could look over the edge of it and see her mother plainly."
    loader = text.split(" ")
    ...
    for i in range(0, 25, 5):
        ...
        name = "probe_multi-layer_print_{jack}-l{tom}~{jerry}".format(jack = 6, tom=i, jerry=i+4)
        draw_blueprint(y, i, name, text)
        
        absname = "probe_multi-layer_absprint_{jack}-l{tom}~{jerry}".format(jack = 6, tom=i, jerry=i+4)
        draw_blueprint(absy, i, absname, text)
